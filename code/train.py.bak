...
import numpy as np
import torch
from lib import H5Dataset, SegDataset, Model, AlignCollate
...
model_save_path = "/home/lishixuan001/ICSI/outputs/inst-seg-discr-loss/models/{}".format(os.path.join(opt.dataset, RUN_ID))
...
if opt.dataset == "CVPPP":
    ...
    train_dataset = H5Dataset(ts.TRAINING_H5, "train")
...
if opt.dataset == "CVPPP":
    ...
    test_dataset = H5Dataset(ts.TRAINING_H5, "test")
assert test_dataset
